        ...
        <div onClick={() => navigate("/course/description/", {state: {...data}})}
           className="text-white w-[22rem] h-[430px] shadow-lg rounded-lg cursor-pointer group overflow-hidden bg-zinc-700">
            ...
            <div className="overflow-hidden">
                <img 
                   className="h-48 w-full rounded-tl-lg rounder-tr-lg group-hover:scale-[1,2] transition-all ease-in-out duration-300"
                ...
                <div className="p-3 space-y-1 text-white">
                    ...
                    <p className="line-clamp-2 font-bold">{data?.description}</p>
